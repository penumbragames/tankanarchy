...
class Powerup extends Entity {
  ...
  constructor(position: Vector, type: Constants.POWERUP_TYPES, data: number,
              duration: number) {
  ...
  static create(): Powerup {
    ...
    const type = <Constants.POWERUP_TYPES>Util.choiceArray(
      Object.keys(Constants.POWERUP_TYPES),
    )
